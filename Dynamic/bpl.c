...
void prompt(void)
{
    while(1)
    {
        ...
        printf("(1) BPL 2015\n");
        printf("(2) BPL 2013\n");
        printf("(3)Promising Players for BPL 2016\n");
        printf("(4) Quit\n");
        printf("Please enter choice:(1 or 2 or 3 or 4)\n");
        int a,choice,flag=0,flag2=0,flag3=0;
        scanf("%d",&a);
        getchar();
        if(a==1)
        {
            while(1)
            {
                ...
                printf("(8) ______GO BACK\n");
                printf("(9)Quit input prompt\n\n");
                printf("Please enter choice:(1 to 9)\n\n");
                scanf("%d",&choice);
                switch(choice)
                {
                case 1:
        ...
        else if(a==3)
        {
            while(1)
            {
                ...
                FILE *fp;
                char character;
                printf("(1) Promising batsmans for BPL 2016\n");
                printf("(2) Promising bowlers for BPL 2016\n");
                printf("(3) ___BACK\n");
